    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    Console.Write("\nPlease insert lenght of the cube edge (in square centimeters): ");
                ...
                {
                    Console.Write("\nPlease insert lenght of the cube edge (in cubic centimeters): ");
                    v = Convert.ToDouble(Console.ReadLine());
                    a = Math.Pow(v, 1.0 / 3.0);
                    s = 6 * a * a;
                    Output(a, s, v);
                }
                else if (key == ConsoleKey.Escape || key == ConsoleKey.Enter)
                {
                    break;
                }
                else
